...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/speaker-diarization/releases/download/v1.0.0/speaker-diarization.zip
SET REPO_DEPENDENCIES_URL=https://raw.githubusercontent.com/kandi1clickkits/speaker-diarization/main/requirements.txt
SET REPO_NAME=speaker-diarization.zip
SET EXTRACTED_REPO_DIR=speaker-diarization
